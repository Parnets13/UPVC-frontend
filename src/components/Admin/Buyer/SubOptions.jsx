...
<div className="flex items-center justify-between mt-6 px-4 py-3">
  <div className="flex items-center gap-2">
    <button
      ...
      className={`p-2 rounded-md ${currentPage === 1 ? 'text-gray-400 cursor-default' : 'text-gray-700 hover:bg-gray-100'}`}
    >
      ...
      {Array.from({ length: Math.min(5, totalPages) }).map((_, i) => {
        ...
        return (
          <button
            ...
            className={`w-10 h-10 rounded-md flex items-center justify-center ${currentPage === page ? 'bg-black text-white' : 'text-gray-700 hover:bg-gray-100'}`}
          >
            {page}
          </button>
        );
    ...
    <button
      ...
      className={`p-2 rounded-md ${currentPage === totalPages ? 'text-gray-400 cursor-default' : 'text-gray-700 hover:bg-gray-100'}`}
    >
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
